...
/**
 * @brief Функция, позволяющая получить форму тетрамино на основе заданной формы и положения.
 *
 * @param p_shape - Форма тетрамино (1-7).
 * @param p_x - Координата X тетрамино.
 * @param p_y - координата тетрамино по оси Y.
 *
 * @return вектор из 4 sf::Vector2i, представляющий позиции миносов в тетрамино.
 */
